              ...
              <img
                ...
                :src="
                  newUploadedImage_base64 != ''
                    ? newUploadedImage_base64
                    : CONFIG_API_IMAGE_URL + menuItemObj.image
                "
...
import { CATEGORIES } from '@/constants/constans.js'
...
const menuItemIdForUpdate = Number(route.params.id || 0)
const isEditMode = menuItemIdForUpdate > 0
    ...
    if (!isEditMode) {
      menuitemService
        ...
        .catch((err) => {
          ...
          //window.alert('Menu Item create failed.')
      ...
      menuitemService
        ...
        .catch((err) => {
          ...
          //window.alert('Menu Item update failed.')
